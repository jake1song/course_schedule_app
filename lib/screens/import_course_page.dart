...
class _ImportCoursePageState extends State<ImportCoursePage> {
  ...
  static List<NativeCourse> _parseText(String text) {
    ...
    // Detect format: CSV/TSV with header, or space-delimited
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                TextButton(onPressed: _parse, child: const Text('解析预览')),
            ...
            if (_message.isNotEmpty)
              Padding(
                ...
                child: Text(_message, style: TextStyle(color: _message.contains('成功') ? Colors.green : Colors.red)),
              ),
            const Divider(),
            Expanded(
              child: _preview.isEmpty
                  ? const Center(child: Text('粘贴课表文本后点击"解析预览"', style: TextStyle(color: Colors.grey)))
                  : ListView.builder(
                        ...
                        return Dismissible(
                          ...
                          child: Card(
                            child: ListTile(
                              ...
                              trailing: c.note.isNotEmpty ? Text(c.note, style: const TextStyle(fontSize: 12, color: Colors.grey)) : null,
                            ),
                          ),
                        );
                      },
